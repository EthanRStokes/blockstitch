...
/** Pointer-drag resize of a side panel, via its edge handle — same "attach
 * listeners for the duration of the drag" shape as canvas/canvasDrag.ts's pan
 * handling, kept self-contained here since nothing else needs to know about
